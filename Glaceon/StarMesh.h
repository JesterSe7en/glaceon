...
#ifndef GLACEON_GLACEON_STARMESH_H_
#define GLACEON_GLACEON_STARMESH_H_
...
class StarMesh {
 public:
  StarMesh(vk::Device logical_device, vk::PhysicalDevice physical_device);
  ~StarMesh();
...
#endif//GLACEON_GLACEON_STARMESH_H_
