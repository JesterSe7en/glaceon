...
// might be better way to store this, but for now just create new enums
enum DescriptorPoolType { IMGUI, FRAME, MESH };
...
class VulkanDescriptorPool {
 public:
  ...
  std::vector<vk::DescriptorSet> &GetDescriptorSet(DescriptorPoolType type) { return vk_descriptor_sets_.at(type); }
  ...
  std::unordered_map<DescriptorPoolType, std::vector<vk::DescriptorSet>> &GetDescriptorSets() { return vk_descriptor_sets_; }
